                    ...
                    <div className="products-section">
                        ...
                        {products.length === 0 ? (
                            <div className="empty-state">
                                ...
                                <p>Start by adding your first product to begin selling amazing tech!</p>
                                <button 
                ...
                {activeTab === 'analytics' && (
                    <div className="analytics-section">
                        <div className="section-header">
                            ...
                            <p>Track your sales and product performance metrics</p>
                        </div>
                ...
                {activeTab === 'settings' && (
                    <div className="settings-section">
                        <div className="section-header">
                            ...
                            <p>Manage your seller preferences and account settings</p>
                        </div>
